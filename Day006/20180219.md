...
curl -u admin:admin -H "X-Requested-By:ambari" -i -X POST http://sandbox-hdp.hortonworks.com:8080/api/v1/clusters/sandbox-hdp.hortonworks.com/services/AMBARI_METRICS/components/METRICS_GRAFANA
 ...
 * Akka 2.0: Scaling Up & Out With Actors (12,199 views), Viktor Klang, tech lead of Akka at Typesafe https://www.youtube.com/watch?v=3jbqTxstlC4


 * Akka: A Shiny New Hammer. Now Show Me Some Nails Already! (4,745 views) https://www.youtube.com/watch?v=uHku7uAe9U0


 * Asynchronous & Non-Blocking Scala — A look at Netty & NIO for Async Networking via Scala (6,340 views) https://www.youtube.com/watch?v=bki5f3Bq7b0


 * Having Fun with Play! 2, Akka and Websocket (6,001 views) https://www.youtube.com/watch?v=mnBiJXfjwII


 * Failure: The Good Parts (4,951 views), Typesafe https://www.youtube.com/watch?v=_XMRYkuaob4


 * Intro to Akka persistence (5,065 views), Typesafe https://www.youtube.com/watch?v=r5lecCBazvE
