...
curl -u admin:admin -H "X-Requested-By:ambari" -i -X POT http://sandbox-hdp.hortonworks.com:8080/api/v1/clusters/sandbox-hdp.hortonworks.com/services/AMBARI_METRICS/components/METRICS_GRAFANA
